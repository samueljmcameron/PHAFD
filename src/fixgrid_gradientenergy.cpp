...
FixGridGradientEnergy::FixGridGradientEnergy(PHAFD *phafd) : Fix(phafd) {

};



void FixGridGradientEnergy::init(const std::vector<std::string> &v_line)
{
...
void FixGridGradientEnergy::setup()
{

}

  
void FixGridGradientEnergy::post_force()
{
